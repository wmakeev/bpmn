...
/**
 * Semantics: If we are to enter a called processing (returningFromSubProcess = false),
 *            the called process is created and a token is put onto its start state.
 ...
 */
BPMNSubProcess.prototype.emitTokens = function emitTokens(currentProcess, data, createBPMNProcess,
  ...
  BPMNCallActivity.prototype.emitTokens.call(this, currentProcess, data, createBPMNProcess,
    returningFromCalledProcess);
};
 ...
 */
BPMNSubProcess.prototype.createCalledProcess =
  function createCalledProcess(callActivityToken, currentProcess, createBPMNProcess, callback) {
 ...
 */
BPMNSubProcess.prototype.getHandler = function getHandler(currentProcess) {
 ...
 * @param {BPMNProcessDefinition} subProcessDefinition
 */
exports.createBPMNSubProcess = function createBPMNSubProcess(node, subProcessDefinition) {
