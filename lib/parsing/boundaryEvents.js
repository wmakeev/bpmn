 ...
 * @return {Boolean}
 */
exports.isBoundaryEventName = function isBoundaryEventName(localName) {
 ...
 * @return {Boolean}
 */
exports.isTimerEventName = function isTimerEventName(localName) {
 ...
 * @constructor
 */
function BPMNBoundaryEvent(bpmnId, name, type,
                                                                               attachedToRef) {
 ...
 */
exports.createBPMNBoundaryEvent = function createBPMNBoundaryEvent(node) {
