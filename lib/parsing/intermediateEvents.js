 ...
 */
exports.createBPMNIntermediateThrowEvent = function createBPMNIntermediateThrowEvent(node) {
 ...
 */
exports.createBPMNIntermediateCatchEvent = function createBPMNIntermediateCatchEvent(node) {
  var getValue = parserUtils.getAttributesValue;
